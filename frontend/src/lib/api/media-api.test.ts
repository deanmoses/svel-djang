...
import { MEDIA_CATEGORIES, MAX_FILE_SIZE_BYTES, IMAGE_ACCEPT } from './media-api';

describe('media-api constants', () => {
	it('MEDIA_CATEGORIES has expected values', () => {
		expect(MEDIA_CATEGORIES).toEqual(['backglass', 'playfield', 'cabinet', 'other']);
	});
